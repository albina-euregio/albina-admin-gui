...
export class ConstantsService {
  ...
  public avActivityCommentTextcat: Record<Exclude<AvalancheProblemStr, "cornices" | "no_distinct_problem">, string> = {
    new_snow:
  ...
  public snowpackStructureCommentTextcat: Record<Exclude<AvalancheProblemStr, "cornices" | "no_distinct_problem">, string> = {
    new_snow:
